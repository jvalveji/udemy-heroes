...
const tipoMaterialController = require('../../../rpm/catalogos/controllers/tipoMaterialController');
 ...
 * GET
 */
router.get('/listarTipoMaterial', tipoMaterialController.getTipoMaterial);
