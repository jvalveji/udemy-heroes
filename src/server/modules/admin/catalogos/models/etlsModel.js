// Definición para el fichero etlsModel.js v4.0.0
// Proyecto: Arca - MEAN
// Definiciones por: Ing. Dagoberto Gómez Jiménez <dgomezj@ccss.sa.cr>
// Descripción: Definición del modelo ETLS de la colección de CATALOGOS
...
if (dbCore) { module.exports = dbCore.model('catalogo-etls', etlsSchema); }
