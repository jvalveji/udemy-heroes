// Definición para el fichero generosModel.js v5.0.0
// Proyecto: Arca - MEAN
// Definiciones por: Ing. Dagoberto Gómez Jiménez <dgomezj@ccss.sa.cr>
// Descripción: Definición del modelo TIPOS_GENERO de la colección de CATALOGOS
...
if (dbCore) { module.exports = dbCore.model('catalogo-genero-tipos', generoSchema); }
