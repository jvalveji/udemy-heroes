// Definición para el fichero perfilesModel.js v5.0.0
// Proyecto: Arca - MEAN
// Definiciones por: Ing. Dagoberto Gómez Jiménez <dgomezj@ccss.sa.cr>
// Descripción: Definición del modelo PERFILES
...
let perfilSchema = new Schema({
	...
	idPerfil: String, //identificador interno
	nombre: String,
	descripcion: String,
	estado: Boolean,
	logs: arcaLog
...
if (dbCore) { module.exports = dbCore.model('catalogo-perfiles', perfilSchema); }
