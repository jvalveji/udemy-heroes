// Definición para el fichero profesionalesModel.js v4.0.0
// Proyecto: Arca - MEAN
// Definiciones por: Yendri González Sánchez <yvgonzals@ccss.sa.cr>
// Descripción: Definición del modelo PROFESIONALES de la colección de CATALOGOS
...
if (dbCore) { module.exports = dbCore.model('catalogo-profesionales', profesionalesSchema); }
