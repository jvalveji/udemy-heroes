// Definición para el fichero serviciosModel.js v5.0.0
// Proyecto: Arca - MEAN
// Definiciones por: Yendri González Sánchez <yvgonzals@ccss.sa.cr>
// Descripción: Definición del modelo SERVICIOS de la colección de CATALOGOS
...
if (dbCore) { module.exports = dbCore.model('catalogo-servicios', serviciosSchema); }
