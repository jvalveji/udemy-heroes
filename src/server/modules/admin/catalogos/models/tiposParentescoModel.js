// Definición para el fichero tiposParentescoModel.js v5.0.0
// Proyecto: Arca - MEAN
// Definiciones por: Yendri González Sánchez <yvgonzals@ccss.sa.cr>
// Descripción: Definición del modelo TIPOS_PARENTESCO de la colección de CATALOGOS
...
let tipoParentescoSchema = new Schema({
	'descripcion': String,
	'estado': Boolean,
	'logs': arcaLog
});

if (dbCore) { module.exports = dbCore.model('catalogo-parentesco-tipos', tipoParentescoSchema); }
