// Definición para el fichero cantonesModel.js v4.0.0
// Proyecto: Arca - MEAN
// Definiciones por: Yendri González Sánchez <yvgonzals@ccss.sa.cr>
// Descripción: Definición del modelo CANTONES de la colección de CATALOGOS
...
let cantonesSchema = new Schema({
	'idSIAH': Number,
	'codigo': Number,
	'idProvinciaSIAH': Number,
	'idProvincia': Schema.Types.ObjectId,
	'descripcion': String,
	'estado': Boolean,
	'logs': arcaLog
});

if (dbCore) { module.exports = dbCore.model('catalogo-cantones', cantonesSchema); }
