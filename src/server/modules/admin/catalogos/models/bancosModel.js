// Definición para el fichero bancosModel.js v3.0.0
// Proyecto: Arca - MEAN
// Definiciones por: Felipe Jimenez Calderon <fjimenca@ccss.sa.cr>
// Descripción: Definición del modelo bancos para las operaciones CRUD en la base de datos mongo.
...
if (dbCore) { module.exports = dbCore.model('catalogo-bancos', bancosSchema); }
