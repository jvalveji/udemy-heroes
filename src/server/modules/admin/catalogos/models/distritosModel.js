// Definición para el fichero distritosModel.js v5.0.0
// Proyecto: Arca - MEAN
// Definiciones por: Yendri González Sánchez <yvgonzals@ccss.sa.cr>
// Descripción: Definición del modelo DISTRITOS de la colección de CATALOGOS
...
let distritosSchema = new Schema({
	'idSIAH': Number,
	'idCantonSIAH': Number,
	'idCanton': Schema.Types.ObjectId,
	'codigo': Number,
	'descripcion': String,
	'estado': Boolean,
	'logs': arcaLog
...
if (dbCore) { module.exports = dbCore.model('catalogo-distritos', distritosSchema); }
