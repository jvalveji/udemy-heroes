// Definición para el fichero jobsModel.js v4.0.0
// Proyecto: Arca - MEAN
// Definiciones por: Ing. Dagoberto Gómez Jiménez <dgomezj@ccss.sa.cr>
// Descripción: Definición del modelo JOBS de la colección de CATALOGOS
...
if (dbCore) { module.exports = dbCore.model('catalogo-jobs', jobsSchema); }
