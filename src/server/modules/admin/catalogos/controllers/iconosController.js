// Definición JavaScript para el controlador catálogo iconos v3.0.0
// Proyecto: Arca - MEAN
...
const catalogoModel = require('./../models/iconosModel');
...
module.exports = {
	/**
	 * @description Función encargada de obtener el catálogo de iconos
	 *
	 */
		...
		catalogoModel.find(_where, function (err, catalogo) {
			if (err) {
				return res.status(500).json({
					message: 'No se pudo obtener el catálogo de iconos.',
					error: err
				});
			}
			if (!catalogo) {
	...
	/**
	 * @description Función encargada de obtener los datos de iconos por su id
	 */
