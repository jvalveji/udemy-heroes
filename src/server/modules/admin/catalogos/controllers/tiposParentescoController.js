// Definición JavaScript para el controlador catálogo tipos de parentesco v3.0.0
// Proyecto: Arca - MEAN
...
module.exports = {
		...
		catalogoModel.find(_where, function (err, catalogo) {
			if (err) {
				return res.status(500).json({
					message: 'No se pudo obtener el catálogo de Tipos de Parentesco.',
					error: err
				});
			}
			if (!catalogo) {
	...
	/**
	 * @description Función encargada de obtener los datos de un tipo de parentesco por su id
	 */
