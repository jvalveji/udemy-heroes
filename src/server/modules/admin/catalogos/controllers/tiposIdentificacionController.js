// Definición JavaScript para el controlador catálogo tipos de identificación v3.0.0
// Proyecto: Arca - MEAN
		...
		catalogoModel.find(_where, function (err, catalogo) {
			if (err) {
				return res.status(500).json({
					message: 'No se pudo obtener el catálogo de Tipos de Identificación.',
					error: err
				});
			}
			if (!catalogo) {
