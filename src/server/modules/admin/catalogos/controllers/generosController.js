// Definición JavaScript para el controlador catálogo tipos de generos v3.0.0
// Proyecto: Arca - MEAN
...
const catalogoModel = require('./../models/generosModel');
...
module.exports = {
		...
		catalogoModel.find(_where, function (err, catalogo) {
			if (err) {
				return res.status(500).json({
					message: 'No se pudo obtener el catálogo de Tipos de Genero.',
					error: err
				});
			}
			if (!catalogo) {
	...
	/**
	 * @description Función encargada de obtener los datos de un tipo de genero por su id
	 */
