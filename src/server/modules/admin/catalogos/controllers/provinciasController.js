// Definición JavaScript para el controlador catálogo provincias v3.0.0
// Proyecto: Arca - MEAN
...
const catalogoModel = require('./../models/provinciasModel');
...
module.exports = {
		...
		catalogoModel.find(_where, function (err, catalogo) {
			if (err) {
				return res.status(500).json({
					message: 'No se pudo obtener el catálogo de Provincias.',
					error: err
				});
			}
			if (!catalogo) {
	...
	/**
	 * @description Función encargada de obtener los datos de una provincia por su id
	 */
