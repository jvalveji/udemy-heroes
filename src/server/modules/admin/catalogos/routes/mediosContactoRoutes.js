// Definición JavaScript para las rutas del Catálogo medios de contacto v3.0.0
// Proyecto: Arca - MEAN
...
//              de los servicios rest asociados al Catálogo medios de contacto.
// Modificado por: (24-06-2020) Ing. Dagoberto Gómez Jiménez

const express = require('express');
let router = express.Router();
const mediosContactoController = require('./../controllers/mediosContactoController');
 ...
 */
router.get('/', mediosContactoController.list);
router.get('/:id', mediosContactoController.show);
/*
 * POST
 * Crea un item en la colección
 */
router.post('/', mediosContactoController.create);
/*
 * PUT
 * Crear o actualizar los items del catálogo
 */
router.put('/:id', mediosContactoController.update);
