// Definición JavaScript para las rutas del Catálogo tipos parentesco v3.0.0
// Proyecto: Arca - MEAN
...
//              de los servicios rest asociados al Catálogo tipos parentesco.
// Modificado por: (24-06-2020) Ing. Dagoberto Gómez Jiménez

const express = require('express');
let router = express.Router();
const tiposPrentescoController = require('./../controllers/tiposParentescoController');
 ...
 */
router.get('/', tiposPrentescoController.list);
router.get('/:id', tiposPrentescoController.show);
/*
 * POST
 * Crea un item en la colección
 */
router.post('/', tiposPrentescoController.create);
/*
 * PUT
 * Crear o actualizar los items del catálogo
 */
router.put('/:id', tiposPrentescoController.update);
