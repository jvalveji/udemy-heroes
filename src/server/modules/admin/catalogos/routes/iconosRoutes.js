// Definición JavaScript para las rutas del Catálogo iconos v3.0.0
// Proyecto: Arca - MEAN
...
//              de los servicios rest asociados al Catálogo iconos.
 ...
 */
router.get('/', iconosController.list);
router.get('/:id', iconosController.show);
/*
 * POST
