// Definición JavaScript para las rutas del Catálogo distritos v3.0.0
// Proyecto: Arca - MEAN
...
//              de los servicios rest asociados al Catálogo distritos.
 ...
 */
router.get('/', distritosController.list);
router.get('/:idCanton', distritosController.showByCanton);
/*
 * POST
 * Crea un item en la colección
 */
router.post('/', distritosController.create);
/*
 * PUT
 * Crear o actualizar los items del catálogo
 */
router.put('/:id', distritosController.update);
