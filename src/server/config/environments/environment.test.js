// Definición para el fichero environment.test.js v1.0.0
// Proyecto: Arca - MEAN
// Definiciones por: Ing. Dagoberto Gómez Jiménez <dgomezj@ccss.sa.cr>
// Descripción: Fichero de configuración del api para el ambiente TEST
...
module.exports = {
	...
	db: {
		mongodb: {
			mixin: {
				core: {
					activo: true,
					url: 'mongodb://arcaCoreUser:Arca.Core.2208@ccssvarcamixi-test.caja.ccss.sa.cr:27017/arca-core'
				},
				archivos: {
					activo: false,
					url: 'mongodb://arcaArchivosUser:Arca.Archivos.2208@ccssvarcamixi-test.caja.ccss.sa.cr:27017/arca-archivos'
				}
			}
		},
	},
	...
	socket: {
		activo: true,
		puerto: 99999, // Puerto donde arranca el socket
		limiteMB: '20mb'
	},
