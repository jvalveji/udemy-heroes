// Definición typescript para el pipe SafeHtmlStylePipe v2.0.0
// Proyecto: Arca - MEAN
...
/**
 * Implementación de DomSanitizer para los estilos CSS que ayuda a prevenir errores de seguridad de Cross Site Scripting
