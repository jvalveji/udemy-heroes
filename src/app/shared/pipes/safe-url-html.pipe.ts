// Definición typescript para el pipe SafeURLPipe v2.0.0
// Proyecto: Arca - MEAN
...
/**
 * Implementación de DomSanitizer para las URL's que ayuda a prevenir errores de seguridad de Cross Site Scripting
