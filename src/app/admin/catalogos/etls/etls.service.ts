...
// Definición typescript para el servicio EtlsService v4.0.0
// Proyecto: Arca - MEAN
...
/**
 * Servicio con las funcionalidades para operar mediante el protocolo HTTP para etls del catálogo general
 */
@Injectable()
export class EtlsService implements ICRUD {
	/** Url del servicio api a consumir por el servicio */
	private apiUrl = environment.urlApi.main + '/admin/catalogos/etls'; // URL web API
	/**
	...
	/**
	 *  Método que obtiene la información de un item especifico en el catálogo
	 * @param nombre Nombre del etl
	 * @returns Retorna un objeto de tipo IHttpResponse con los datos del catálogo solicitado
	 */
	public ShowByNombre(nombre: string): Promise<IHttpResponse> {
