// Definición typescript para el componente EtlsEditarComponent v3.0.0
// Proyecto: Arca - MEAN
...
@Activate(['adm_cat_etls'])
/**
 * Componente destinado al despligue y manejo del catálogo de ETL's
 */
@Component({
	selector: 'arca-etls-editar',
	templateUrl: './etls-editar.component.html',
	styleUrls: ['./etls-editar.component.scss'],
	providers: [EtlsService]
})
export class EtlsEditarComponent implements OnInit {
	/**
	 ...
	 * @param etlsService Variable que representa a los servicios de etls del core base
	 * @param msgBox Representa el servicio para las ventanas de dialogo
	 */
	constructor(private _location: Location,
		private catalogoService: EtlsService,
	...
	public AgregarItem(): void {
		this.esEdicion = true;
		if (
			this.item.idEtl === null ||
			this.item.idEtl === undefined ||
			this.item.idEtl === '' ||
	 ...
	 */
	public ngOnInit() {
		// Carga el catálogo de tipos de etls
		this.ObtenerCatalogo();
	};
}
