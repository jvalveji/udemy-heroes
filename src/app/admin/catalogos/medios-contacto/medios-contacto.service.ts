// Definición typescript para el servicio MediosContactoService v4.0.0
// Proyecto: Arca - MEAN
...
/** Servicio con las funcionalidades para operar mediante el protocolo HTTP para medios de contacto del catálogo general */
@Injectable()
export class MediosContactoService implements ICRUD {
	/** Url del servicio api a consumir por el servicio */
	private apiUrl = environment.urlApi.main + '/admin/catalogos/medios-contacto'; // URL web API
	/**
