// Definición typescript para el componente MediosContactoEditarComponent v4.0.0
// Proyecto: Arca - MEAN
...
import { MediosContactoService } from './medios-contacto.service';
...
@Activate(['adm_cat_medios_contacto'])
/**
 * Componente destinado al despligue y manejo del catálogo de tipos de medios de contacto
 */
@Component({
	selector: 'arca-medios-contacto-editar',
	templateUrl: './medios-contacto-editar.component.html',
	styleUrls: ['./medios-contacto-editar.component.scss'],
	encapsulation: ViewEncapsulation.Emulated
})
export class MediosContactoEditarComponent implements OnInit {
	/**
	 ...
	 * @param catalogoService Variable que representa a los servicios del core base
	...
	constructor(private _location: Location,
		private catalogoService: MediosContactoService,
	 ...
	 */
	public ngOnInit() {
		// Carga el catálogo de tipos de medios de contacto
		this.ObtenerCatalogo();
	};
}
