// Definición typescript para el servicio TiposFuncionarioService v4.0.0
// Proyecto: Arca - MEAN
...
/** Servicio con las funcionalidades para operar mediante el protocolo HTTP para tipos de funcionario del catálogo general */
@Injectable()
export class TiposFuncionarioService implements ICRUD {
	/** Url del servicio api a consumir por el servicio */
	private apiUrl =
		environment.urlApi.main + '/admin/catalogos/tipos-funcionario'; // URL web API
	/**
