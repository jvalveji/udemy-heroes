// Definición typescript para el servicio TiposParentescoService v4.0.0
// Proyecto: Arca - MEAN
...
/** Servicio con las funcionalidades para operar mediante el protocolo HTTP para tipos de parentesco del catálogo general */
@Injectable()
export class TiposParentescoService implements ICRUD {
	/** Url del servicio api a consumir por el servicio */
	private apiUrl = environment.urlApi.main + '/admin/catalogos/tipos-parentesco'; // URL web API
	/**
