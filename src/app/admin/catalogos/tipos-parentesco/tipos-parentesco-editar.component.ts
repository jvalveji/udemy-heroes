// Definición typescript para el componente TiposParentescoEditarComponent v4.0.0
// Proyecto: Arca - MEAN
...
import { TiposParentescoService } from './tipos-parentesco.service';
...
@Activate(['adm_cat_tipos_parentesco'])
/**
 * Componente destinado al despligue y manejo del catálogo de tipos de parentesco
 */
@Component({
	selector: 'arca-tipos-parentesco',
	templateUrl: './tipos-parentesco-editar.component.html',
	styleUrls: ['./tipos-parentesco-editar.component.scss'],
	encapsulation: ViewEncapsulation.Emulated
})
export class TiposParentescoEditarComponent implements OnInit {
	/**
	...
	constructor(private _location: Location,
		private catalogoService: TiposParentescoService,
	 ...
	 */
	public ngOnInit() {
		// Carga el catálogo de tipos de parentesco
		this.ObtenerCatalogo();
	};
}
