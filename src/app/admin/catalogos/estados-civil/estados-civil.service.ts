// Definición typescript para el servicio EstadosCivilService v4.0.0
// Proyecto: Arca - MEAN
...
/** Servicio con las funcionalidades para operar mediante el protocolo HTTP para estados civiles desde catálogo general */
@Injectable()
export class EstadosCivilService implements ICRUD {
	/** Url del servicio api a consumir por el servicio */
	private apiUrl = environment.urlApi.main + '/admin/catalogos/estados-civil'; // URL web API
	/**
