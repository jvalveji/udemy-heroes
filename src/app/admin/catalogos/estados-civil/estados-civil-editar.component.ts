// Definición typescript para el componente EstadosCivilEditarComponent v4.0.0
// Proyecto: Arca - MEAN
...
@Activate(['adm_cat_estados_civil'])
/**
 * Componente destinado al despligue y manejo del catálogo de tipos de estado civil
 */
@Component({
	selector: 'arca-estados-civil-editar',
	templateUrl: './estados-civil-editar.component.html',
	styleUrls: ['./estados-civil-editar.component.scss'],
	encapsulation: ViewEncapsulation.Emulated
})
export class EstadosCivilEditarComponent implements OnInit {
	/**
	 ...
	 * @param catalogoService Variable que representa a los servicios de estados cíviles desde el core base
	...
	constructor(
		...
		private catalogoService: EstadosCivilService,
	 ...
	 */
	public ngOnInit() {
		// Carga el catálogo de tipos de estado civil
		this.ObtenerCatalogo();
	}
}
