// Definición typescript para el servicio PaisesService v4.0.0
// Proyecto: Arca - MEAN
...
/** Servicio con las funcionalidades para operar mediante el protocolo HTTP para paises del catálogo general */
@Injectable()
export class PaisesService implements ICRUD {
	/** Url del servicio api a consumir por el servicio */
	private apiUrl = environment.urlApi.main + '/admin/catalogos/paises'; // URL web API
	/**
