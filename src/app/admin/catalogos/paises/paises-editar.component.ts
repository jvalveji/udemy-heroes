// Definición typescript para el componente PaisesEditarComponent v4.0.0
// Proyecto: Arca - MEAN
// Definiciones por: Yendri González Sánchez <yvgonzals@ccss.sa.cr>
// Modificado: (10-06-2020) Ing. Dagoberto Gómez Jiménez
...
@Activate(['adm_cat_paises'])
/**
 * Componente destinado al despligue y manejo del catálogo de países
 */
@Component({
	selector: 'arca-paises',
...
export class PaisesEditarComponent implements OnInit {
	...
	public pruebas = Array.from({ length: 100000 }).map((_, i) => `Item #${i}`);

	/**
	 * Constructor de la clase
	 * @param _location Parametro que representa el servicio de localización de rutas
	 * @param paisesService Variable que representa a los servicios del core base
	...
	constructor(private _location: Location,
		private catalogoService: PaisesService,
