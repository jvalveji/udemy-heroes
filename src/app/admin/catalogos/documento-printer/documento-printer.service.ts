...
// Definición typescript para el servicio DocumentoPrinterService v3.0.0
// Proyecto: Arca - MEAN
...
/** Servicio con las funcionalidades para operar mediante el protocolo HTTP para documentos para imprimir mediante servicio arcaPrinters */
@Injectable()
export class DocumentoPrinterService implements ICRUD {
	/** Url del servicio api a consumir por el servicio */
	private apiUrl = environment.urlApi.main + '/admin/catalogos/documento-printer/'; // URL web API
