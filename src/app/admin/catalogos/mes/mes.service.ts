// Definición typescript para el servicio MesService v4.0.0
// Proyecto: Arca - MEAN
...
/**
 * Servicio con las funcionalidades para operar mediante el protocolo HTTP para meses del catálogo general
 */
@Injectable()
export class MesService implements ICRUD {
	/**
	 * Url del servicio api a consumir por el servicio
	 */
	private apiUrl =
		environment.urlApi.main + '/admin/catalogos/mes'; // URL web API
	/**
