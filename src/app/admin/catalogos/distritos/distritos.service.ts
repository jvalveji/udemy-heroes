// Definición typescript para el servicio DistritosService v4.0.0
// Proyecto: Arca - MEAN
...
/** Servicio con las funcionalidades para operar mediante el protocolo HTTP para distritos */
@Injectable()
export class DistritosService implements ICRUD {
	/** Url del servicio api a consumir por el servicio */
	private apiUrl = environment.urlApi.main + '/admin/catalogos/distritos'; // URL web API
	/**
	...
	/**
	 * Método que obtiene la información del catálogo de distritos
	 * @param id Id del Canton
	 * @returns Retorna un objeto de tipo IHttpResponse con los datos solicitados
	 */
	public ShowDistritoByCanton(data: any): Promise<IHttpResponse> {
