// Definición typescript para el componente TiposIdentificacionEditarComponent v4.0.0
// Proyecto: Arca - MEAN
...
@Activate(['adm_cat_tipos_identificacion'])
/**
 * Componente destinado al despligue y manejo del catálogo de tipos de identificación
 */
@Component({
	selector: 'arca-tipos-identificacion-editar',
	templateUrl: './tipos-identificacion-editar.component.html',
	styleUrls: ['./tipos-identificacion-editar.component.scss'],
	encapsulation: ViewEncapsulation.Emulated
})
export class TiposIdentificacionEditarComponent implements OnInit {
	/**
	 ...
	 * @param catalogoService representa el servicio para tipos de identificación
	...
	constructor(
		...
		private catalogoService: TiposIdentificacionService,
	 ...
	 */
	public ngOnInit() {
		// Carga el catálogo de tipos de identificaciones
		this.ObtenerCatalogo();
	}
}
