// Definición typescript para el servicio TiposIdentificacionService v4.0.0
// Proyecto: Arca - MEAN
...
@Injectable()
export class TiposIdentificacionService implements ICRUD {
	/** Url del servicio api a consumir por el servicio */
	private apiUrl =
		environment.urlApi.main + '/admin/catalogos/tipos-identificacion'; // URL web API
	/**
