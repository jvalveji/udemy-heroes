// Definición typescript para el servicio UnidadesMedidaService v4.0.0
// Proyecto: Arca - MEAN
...
/**
 * Servicio unidades de medida para las transacciones CRUD hacia el servidor
 */
@Injectable()
export class UnidadesMedidaService implements ICRUD {
	/**
	 * Url del servicio api a consumir por el servicio
	 */
	private apiUrl = environment.urlApi.main + '/admin/catalogos/unidades-medida'; // URL web API
