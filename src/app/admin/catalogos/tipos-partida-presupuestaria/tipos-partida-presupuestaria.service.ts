// Definición typescript para el servicio TiposPartidaPresupuestariaService v2.0.0
// Proyecto: Arca - Nutrición
// Definiciones por: Ing. Felix Lee Pan <fleepan@ccss.sa.cr> (26-05-2020)
...
/**
 * Servicio con las funcionalidades para operar mediante el protocolo HTTP para tipos de partida presupuestaria
 */
@Injectable()
export class TiposPartidaPresupuestariaService implements ICRUD {
	/**
	 * Url del servicio api a consumir por el servicio
	 */
	private apiUrl =
		environment.urlApi.main + '/catalogos/tipos-partida-presupuestaria'; // URL web API
