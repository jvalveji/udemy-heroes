...
// Definición typescript para el servicio JobsService v4.0.0
// Proyecto: Arca - MEAN
...
/**
 * Servicio con las funcionalidades para operar mediante el protocolo HTTP para jobs del catálogo general
 */
@Injectable()
export class JobsService implements ICRUD {
	/** Url del servicio api a consumir por el servicio */
	private apiUrl = environment.urlApi.main + '/admin/catalogos/jobs'; // URL web API
	/**
