// Definición typescript para el componente JobsEditarComponent v3.0.0
// Proyecto: Arca - MEAN
...
@Activate(['adm_cat_jobs'])
/**
 * Componente destinado al despligue y manejo del catálogo de tipos de género
 */
@Component({
	selector: 'arca-jobs-editar',
	templateUrl: './jobs-editar.component.html',
	styleUrls: ['./jobs-editar.component.scss'],
	providers: [JobsService]
})
export class JobsEditarComponent implements OnInit {
	/**
	 ...
	 * @param jobsService Variable que representa a los servicios de jobs del core base
	 * @param msgBox Representa el servicio para las ventanas de dialogo
	 */
	constructor(private _location: Location,
		private catalogoService: JobsService,
	...
	public AgregarItem(): void {
		this.esEdicion = true;
		if (
			this.item.idJob === null ||
			this.item.idJob === undefined ||
			this.item.idJob === '' ||
			this.item.idJobPentaho === null ||
			this.item.idJobPentaho === undefined ||
			this.item.idJobPentaho === '' ||
	 ...
	 */
	public ngOnInit() {
		// Carga el catálogo de tipos de jobs
		this.ObtenerCatalogo();
	};
}
