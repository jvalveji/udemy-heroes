...
// Definición typescript para el servicio GrupoRHService v4.0.0
// Proyecto: Arca - MEAN
...
/**
 * Servicio encargado de exponer el CRUD para el manejo del catálogo de tipos de grupos RH
 */
@Injectable()
export class GrupoRHService implements ICRUD {

	/**
	 * Url del servicio api a consumir por el servicio
	 */
	private apiUrl = environment.urlApi.main + '/admin/catalogos/grupo-rh'; // URL web API
