// Definición typescript para el servicio GenerosService v4.0.0
// Proyecto: Arca - MEAN
...
/** Servicio con las funcionalidades para operar mediante el protocolo HTTP para generos del catálogo general */
@Injectable()
export class GenerosService implements ICRUD {
	/** Url del servicio api a consumir por el servicio */
	private apiUrl = environment.urlApi.main + '/admin/catalogos/generos'; // URL web API
	/**
