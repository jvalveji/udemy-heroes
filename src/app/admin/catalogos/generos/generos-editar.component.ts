// Definición typescript para el componente GenerosEditarComponent v4.0.0
// Proyecto: Arca - MEAN
...
@Activate(['adm_cat_generos'])
/**
 * Componente destinado al despligue y manejo del catálogo de tipos de género
 */
@Component({
	selector: 'arca-generos-editar',
	templateUrl: './generos-editar.component.html',
	styleUrls: ['./generos-editar.component.scss'],
	encapsulation: ViewEncapsulation.Emulated
})
export class GenerosEditarComponent implements OnInit {
	/**
	 ...
	 * @param catalogosService Variable que representa a los servicios de generos del core base
	...
	constructor(private _location: Location,
		private catalogoService: GenerosService,
