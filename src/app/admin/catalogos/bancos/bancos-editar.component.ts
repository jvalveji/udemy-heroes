// Definición typescript para el componente bancos-editar.Component v2.0.0
// Proyecto: Arca - MEAN
...
/**
 * Componente destinado al despligue y manejo del catálogo de bancos
 */
@Component({
	selector: 'arca-bancos-editar',
	templateUrl: './bancos-editar.component.html',
	styleUrls: ['./bancos-editar.component.scss']
})
export class BancosEditarComponent implements OnInit {
	...
	constructor(
		...
		private catalogoService: BancosService,
	...
	public AgregarItem(): void {
		this.esEdicion = true;
		/**Se verifica que los campos de formulario esten completos */
		if (
	...
	/**
	 * Método en cargado de obtener el catalogo de bancos.
	 */
