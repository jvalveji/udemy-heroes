// Definición typescript para el servicio EspecialidadesService v4.0.0
// Proyecto: Arca - MEAN
...
/** Servicio con las funcionalidades para operar mediante el protocolo HTTP para especialidades del catálogo general */
@Injectable()
export class EspecialidadesService implements ICRUD {
	/** Url del servicio api a consumir por el servicio */
	private apiUrl = environment.urlApi.main + '/admin/catalogos/especialidades/'; // URL web API
	/**
	...
	/**
	 * Método que obtiene la información del catálogo de especialidades
	 * @param id Id del Servicio
	 * @returns Retorna un objeto de tipo IHttpResponse con los datos solicitados
	 */
	public ShowEspecialidadesByServicio(data: any): Promise<IHttpResponse> {
