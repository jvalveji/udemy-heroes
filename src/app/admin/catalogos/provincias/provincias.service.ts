// Definición typescript para el servicio ProvinciasService v4.0.0
// Proyecto: Arca - MEAN
...
/** Servicio con las funcionalidades para operar mediante el protocolo HTTP para provincias del catálogo general */
@Injectable()
export class ProvinciasService implements ICRUD {
	/** Url del servicio api a consumir por el servicio */
	private apiUrl = environment.urlApi.main + '/admin/catalogos/provincias'; // URL web API
	/**
