// Definición typescript para el servicio CantonesService v4.0.0
// Proyecto: Arca - MEAN
...
/** Servicio con las funcionalidades para operar mediante el protocolo HTTP para cantones del catálogo general */
@Injectable()
export class CantonesService implements ICRUD {
	/** Url del servicio api a consumir por el servicio */
	private apiUrl = environment.urlApi.main + '/admin/catalogos/cantones'; // URL web API
	...
	/**
	 * Método que obtiene la información del catálogo de cantones
	 * @param id objectId de la Provincia
	 * @returns Retorna un objeto de tipo IHttpResponse con los datos solicitados
	 */
	public ShowCantonByProvincia(data: any): Promise<IHttpResponse> {
